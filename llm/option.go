...
type GenerateOptions struct {
	...
	StreamingFunc          func(ctx context.Context, chunk []byte, toolResults []MCPToolExecutionResult) error `json:"-"`                             // 流式响应的回调函数
...
func WithStreamingFunc(streamingFunc func(ctx context.Context, chunk []byte, toolResults []MCPToolExecutionResult) error) GenerateOption {
	return func(o *GenerateOptions) {
